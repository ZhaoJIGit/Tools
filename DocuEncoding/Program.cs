...
namespace DocuEncoding
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // 输入文件路径和输出文件路径
            string inputFilePath =Path.Combine(Directory.GetCurrentDirectory(), "重生1993，暗海.txt");
            string outputFilePath = Path.Combine(Directory.GetCurrentDirectory(), "重生1993，暗海2.txt");
